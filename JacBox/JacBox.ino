...
int armOff = 113;  //This is the arm value where the switch is turmed off
int armFake = 103; //This is the arm value that may be touching the switch, but not turning it off 
int armIn = 20;    //This is the arm value where the arm is inside the box / neutral

int lidClose = 60;  //This is the lid value where the lid is closed
int lidNarrow = 155   //This is the lid value where the lid is opened part way
int lidOpen = 155;   //This is the lid value where the lid is opened all the way

int flagOff = 50;  //This is when the surrender flag is fully down
int flagStart = 130;   //This is when the surrender flag starts to wave
int flagEnd = 150;    //This is when the surrender flag ends the wave
